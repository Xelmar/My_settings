...
alias font_colors="for code ({000..255}) print -P -- '\$code: \%F{\$code}This is how your text would look like\%f'"
...
plugins=(git dir command_execution_time)

POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(os_icon dir_writable dir vcs)
POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(status command_execution_time time)

#___________LEFT_PROMPT_________________
...
#___________RIGTH_PROMPT________________
